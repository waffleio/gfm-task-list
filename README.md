...
#### npmcdn
```html
<link href="https://npmcdn.com/gfm-task-list@1.0.1/dist/gfm-task-list.min.css" rel="stylesheet" type="text/css"></link>
<script src="https://npmcdn.com/gfm-task-list@1.0.1/dist/gfm-task-list.min.js"></script>
```
